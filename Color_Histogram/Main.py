...
image = cv2.imread('C:/Users/Regina/PycharmProjects/MULTIRE_MP1/src_codes/Images/119.jpg',0)
...
plt.subplot(221), plt.imshow(image, "gray")
plt.subplot(222), plt.imshow(fullImageMask, "gray")
plt.subplot(223), plt.imshow(centerMask, "gray")
